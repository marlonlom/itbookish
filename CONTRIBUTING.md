...
[ItBookish Code of Conduct](CODE_OF_CONDUCT.md).
...
Before you ask a question, it is best to search for existing [Issues](https://github.com/marlonlom/itbookish/issues) that
...
- Open an [Issue](https://github.com/marlonlom/itbookish/issues/new).
...
- To see if other users have experienced (and potentially already solved) the same issue you are having, check if there
  ...
  the [bug tracker](https://github.com/marlonlom/itbookish/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/marlonlom/itbookish/issues/new). (Since we can't be sure at this point whether it is
...
This section guides you through submitting an enhancement suggestion for ItBookish, **including completely new features
...
- Read the [documentation]() carefully and find out if the functionality is already covered, maybe by an individual
  configuration.
- Perform a [search](https://github.com/marlonlom/itbookish/issues) to see if the enhancement has already been suggested.
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/marlonlom/itbookish/issues).
